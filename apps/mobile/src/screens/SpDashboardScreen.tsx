      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.statsGrid}>
          <View style={styles.statBox}>
            ...
            <Text style={styles.statValue}>
              {isStatsLoading ? <ActivityIndicator size="small" color={colors.accentPrimary} /> : totalNrtDistributed.toLocaleString(undefined, { maximumFractionDigits: 2 })}
            </Text>
          </View>
              ...
              {services.length > 0 ? (
                <View style={styles.networkBox}>
                  ...
                  <View style={{ flex: 1, marginLeft: 12 }}>
                    <Text style={styles.networkName}>{services[activeServiceIndex]?.name || 'SERVICE'}</Text>
          ...
          {isSpTelemetryLoading ? (
            ...
            <View style={styles.emptyState}>
             ...
             <View style={{ paddingVertical: 16 }}>
               <Text style={{ color: colors.textPrimary, fontSize: 16, fontWeight: 'bold' }}>ROI Data Active</Text>
             </View>
          )}
        </View>
        ...
        <View style={styles.card}>
          ...
          {isSpTelemetryLoading ? (
            ...
            <View style={{ paddingVertical: 16 }}>
              <Text style={{ color: colors.textPrimary, fontSize: 16, fontWeight: 'bold' }}>Insights Active</Text>
            </View>
          )}
        </View>
        ...
        <View style={styles.card}>
          ...
          {isSpHeatmapLoading ? (
             <View style={{ paddingVertical: 32 }}><ActivityIndicator color={colors.textSecondary} /></View>
          ) : (!spHeatmap || spHeatmap.length === 0 || spHeatmap.every((d:any) => d.intensity === 0)) ? (
            <View style={styles.emptyState}>
