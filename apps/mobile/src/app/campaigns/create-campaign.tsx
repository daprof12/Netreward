    ...
    <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
      ...
      <ScrollView style={{ flex: 1 }} contentContainerStyle={{ padding: 20, paddingBottom: 100 }} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          <Text style={styles.label}>Select Verified Service</Text>
          {services.length === 0 ? (
            <View style={styles.emptyBox}>
              <Text style={{ color: colors.textSecondary, textAlign: 'center' }}>You need to create a Service first.</Text>
            </View>
          ) : (
            <>
            ...
            <ScrollView style={{ maxHeight: 300 }}>
              {services.map(s => (
                <Pressable
                  ...
                  onPress={() => { updateCampaignDraft({ serviceId: s.id }); setShowServiceDropdown(false); }}
                >
