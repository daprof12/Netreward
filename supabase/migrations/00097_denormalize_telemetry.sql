-- Migration: 00097_denormalize_telemetry.sql
-- Description: Adds service_id, network_id, category, and gaming_account_id to telemetry tables for analytics performance.

-- 1. Add columns to device_data_sessions
ALTER TABLE public.device_data_sessions
  ADD COLUMN IF NOT EXISTS service_id UUID REFERENCES public.services(id) ON DELETE SET NULL,
  ADD COLUMN IF NOT EXISTS network_id UUID REFERENCES public.networks(id) ON DELETE SET NULL,
  ADD COLUMN IF NOT EXISTS category TEXT,
  ADD COLUMN IF NOT EXISTS gaming_account_id UUID REFERENCES public.gaming_accounts(id) ON DELETE SET NULL;

-- 2. Add columns to tracking_sessions
...
-- 3. Replace process_tracking_report to populate these new fields
