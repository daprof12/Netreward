-- Migration: Admin Withdrawal Processing RPC
-- Created: 2026-05-02
...
BEGIN
    ...
    SELECT user_id, amount_nrt, status INTO v_user_id, v_amount_nrt, v_current_status
    ...
    -- If processed successfully, move NRT to Admin Treasury
    ...
    -- If rejected or failed, we must refund
