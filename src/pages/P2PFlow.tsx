            ...
            <div className="space-y-5 pt-2">
              ...
              >
                ...
                <div className="text-right">
                  <p className="font-bold text-text-primary">${currentPrice.toFixed(4)}</p>
            ...
            <div className="space-y-5 pt-2">
              ...
              <div className="glass rounded-xl border border-glass-border p-4 space-y-4">
                ...
                <div className="border-t border-glass-border/50 pt-3">
                  ...
                  <p className="text-xs text-text-secondary mt-0.5">Rate: 1 NRT = ${currentPrice.toFixed(4)} · <span className="text-emerald-400 font-semibold">0 Fee</span></p>
                </div>
              </div>
