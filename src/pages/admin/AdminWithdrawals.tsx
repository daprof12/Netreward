    ...
    <motion.div className="space-y-5" initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }}>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="glass p-4 rounded-2xl border border-glass-border bg-gradient-to-br from-accent-primary/20 to-purple-500/20">
          ...
          <h3 className="text-2xl font-black text-text-primary mt-1">{treasuryBalance.toLocaleString(undefined, { maximumFractionDigits: 7 })} NRT</h3>
                  ...
                  filteredWithdrawals.map(req => (
                    <tr key={req.id} onClick={() => setSelectedReq(req)} className="hover:bg-bg-secondary/50 transition-colors cursor-pointer">
                      ...
                      <td className="px-4 py-3">
                        ...
                        <div className="text-xs text-text-secondary">{req.amount_nrt.toLocaleString(undefined, { maximumFractionDigits: 7 })} NRT deducted</div>
                      </td>
                      <td className="px-4 py-3">
                    ...
                    filteredDeposits.map(dep => {
                      return (
                        <tr key={dep.id} className="hover:bg-bg-secondary/50 transition-colors">
                          ...
                          <td className="px-4 py-3 text-accent-primary font-bold">{dep.amount.toLocaleString(undefined, { maximumFractionDigits: 7 })} NRT</td>
                ...
                <div className="flex justify-between items-center glass p-4 rounded-xl border border-glass-border">
                  <div>
                    ...
                    <p className="text-2xl font-black text-text-primary">
                      {selectedReq.withdrawal_type === 'crypto' ? `${selectedReq.amount_nrt.toLocaleString(undefined, { maximumFractionDigits: 7 })} NRT` : `${selectedReq.amount_fiat.toLocaleString()} ${selectedReq.currency}`}
                    </p>
