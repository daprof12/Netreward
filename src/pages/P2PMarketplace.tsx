      ...
      <div className="space-y-4 mb-6">
        ...
        <div className="flex items-center gap-2 p-3 bg-accent-primary/5 rounded-xl border border-accent-primary/10">
          ...
          <p className="text-xs font-medium text-text-primary">
            NRT Live Price: <span className="font-bold">{symbol}{(NRT_LIVE_PRICE * rate).toFixed(4)}</span>
          </p>
        </div>
      </div>
            ...
            >
              <div className="flex justify-between items-start">
                ...
                <div className="text-right">
                  ...
                  <p className="text-lg font-black text-text-primary">{symbol}{(offer.price * rate).toFixed(3)}</p>
                </div>
              </div>
