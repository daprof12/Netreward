            ...
            >
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                <div className="flex gap-2 mb-2">
                  {(['user', 'sp', 'isp'] as UserRole[]).map((role) => (
                    <button
                      key={role}
                      type="button"
              ...
              <div className="mt-6">
                ...
                <div className="flex gap-3 mt-4">
                  <button type="button" className="flex-1 glass flex items-center justify-center py-2.5 rounded-xl border border-glass-border hover:bg-glass-bg/50 transition-colors">
