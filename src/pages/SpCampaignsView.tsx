...
import { 
  ...
  ChevronRight, Users, Smartphone, Laptop, Loader2, TrendingUp 
} from 'lucide-react';
...
export default function SpCampaignsView() {
  ...
  const handleDeleteService = (id: string) => {
    if (confirm('Are you sure you want to delete this service? All associated campaigns will be stopped.')) {
      deleteService(id);
          ...
          >
            ...
            >
              ...
              <div className="p-4 space-y-2">
                ...
                <Link 
                  to={`/campaigns/edit-campaign/${managingCampaign.id}`}
                  className="w-full flex items-center gap-3 p-3 rounded-xl hover:bg-bg-secondary transition-colors text-left"
                >
...
function CampaignAnalyticsModal({ campaign, onClose }: { campaign: SpCampaign; onClose: () => void }) {
