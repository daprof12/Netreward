...
export default function CreateService() {
  ...
  const handleContinue = () => {
    ...
    setTimeout(async () => {
      const generatedApiKey = 'nr_live_' + crypto.randomUUID().replace(/-/g, '').slice(0, 24);
      ...
      <AnimatePresence mode="wait">
          ...
          >
            ...
            <div className="space-y-6 pt-4 border-t border-glass-border">
              <div>
                ...
                <p className="text-xs text-text-secondary">URLs are used for tracking when users visit your platform or launch your app.</p>
              </div>
        ...
        {step === 'verifying' && (
          ...
          >
            ...
            <div>
              <h2 className="text-2xl font-bold mb-2">Registering Service</h2>
              <p className="text-text-secondary">Setting up your service and generating your API key...</p>
            </div>

            <div className="w-full glass rounded-xl border border-glass-border p-4 space-y-3 mt-8">
              {[
                {text: 'Validating platform URLs...', done: true},
                {text: 'Generating API key...', done: true},
                {text: 'Activating service tracking...', done: false},
              ].map((item, i) => (
        ...
        {step === 'success' && (
          ...
          >
            ...
            <div className="space-y-1">
              ...
              <p className="text-sm text-text-secondary">Your service is active. Use the API key below to integrate the NetReward SDK.</p>
            </div>
              ...
              <div className="w-full space-y-4 pt-4">
                ...
                <div className="p-4 bg-accent-primary/5 border border-accent-primary/20 rounded-xl flex items-start gap-3 text-left">
                  ...
                  <p className="text-[10px] text-text-secondary leading-relaxed">
                    Store this API key securely. This single key is used for both SDK integration and payment checkout. You can view it later from your Service Settings.
                  </p>
                </div>
              </div>
            )}
